	        ...
	        <div style="margin-top:5px;padding:0 10px;min-height:370px;">
	        	<div style="height:820px;width:720px;">
	        		...
	        		<div style="float:right;">
	        			<input type="submit" name="publish" value="提   交" onclick="publish()" id="publish" style="border-width:0px;margin-top:5px;color:#fff;font-weight:bold;height:30px;width:80px;background:url(<%=request.getContextPath() %>/image/nav_bg.png) repeat-x" />
	        		</div>
	        		</div>
