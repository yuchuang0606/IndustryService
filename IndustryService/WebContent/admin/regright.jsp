...
<body>
	...
	<div class="location">
		<div class="loccontent">
			...
			<a href="<%=request.getContextPath() %>/index.jsp">首页</a> 》 <a href="<%=request.getContextPath() %>/admin/index.jsp">管理中心</a> 》 注册协议管理
			</span>
		</div>
	</div>
	<div id="main" class="main">
		...
		<div id="content" class="content"">
			<div class="title" style="height:36px;wclassth:100%;line-height:36px;margin:0px auto;text-align:center;background-color:#f5f5f5">
	        	<span style="font-size:16px;"><strong>用户注册协议配置</strong></span>
	        </div>
	        <div style="margin-top:15px;padding:0 10px;">
	        	<form action="<%=request.getContextPath() %>/user/configdata?type=regright" method="post">
				<table width="719px" border="0" cellpadding="0" cellspacing="0" align="center">				
					<tr>
						<td align="center">
			        		<textarea id="editor1" class="ckeditor" name="content" style=""><%=regright.getDescription() %></textarea>
                        </td>
                    </tr>
					<tr>
